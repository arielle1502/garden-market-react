     ...
     <b-icon icon="search"></b-icon>
      ...
      <ListGroup >
                 ...
                 <InputGroup className="mb-2 location">
                   ...
                   <!-- category dropdown --> */}
                    <DropdownButton block menu-className="w-100" className="mb-2" id="dropdown-item-button"  title="Category">
           ...
           <Dropdown.Divider></Dropdown.Divider>
                   ...
                   {/* <!-- end category dropdown -->
                      <!-- km dropdown --> */}
                    <DropdownButton block menu-className="w-100" className="mb-2"id="dropdown-item-button"  title="+km">
           ...
           <Dropdown.Divider></Dropdown.Divider>
                   ...
                   {/* <!-- end km dropdown -->
                     <!-- price dropdown --> */}
                    <DropdownButton block menu-className="w-100" className="mb-2" id="dropdown-item-button"  title="Price">
